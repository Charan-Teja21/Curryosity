...
import { fetchUserByUsername } from "../../redux/slices/userSlice"; // <-- import the new thunk
...
function UserDashBoard() {
  ...
  async function handleFileUpload(event) {
    ...
    try {
      ...
      // Fetch updated user info (this will update currentUser in Redux and localStorage)
      dispatch(fetchUserByUsername(currentUser.username));
      setImge(false);
      ...
      <div className="row row-cols-2">
        ...
        <div className="col-4">
          <div className="row row-cols-1 text-center elements">
            ...
            {(!currentUser.profileImage || !currentUser.profileImage.data) ? (
              <>
                ...
                {imge === false ? (
                  <>
                    ...
                    <form onSubmit={handleFileUpload}>
                      ...
                      <button className="btn rounded bg-primary" disabled={uploading}>
                ...
                <>
                  <img
                    ...
                    src={`data:${currentUser.profileImage.contentType};base64,${currentUser.profileImage.data}`}
                    alt=""
                  />
                </>
              )}
